...
cl /nologo /O2 /LD /EHa /utf-8 "%~dp0..\src\dllmain.cpp" /Fo:"%~dp0..\build\dllmain.obj" /Fe:"%~dp0..\dist\ToolbagChineseHook.dll" /link /IMPLIB:"%~dp0..\build\ToolbagChineseHook.lib"
